...
train_data = dict(
    type='CocoDataset',
    classes=('spectrum', ),
    ann_file='D:/ZXS/dataset2/annotations_805/instances_train.json',
    img_prefix='D:/ZXS/dataset2/train/images/',
    pipeline=[
        dict(type='LoadImageFromFile', to_float32=True),
        dict(
        ...
        dict(type='DefaultFormatBundle', img_to_float=True),
        dict(
            type='Collect', keys=['img', 'gt_labels', 'gt_bboxes', 'gt_masks'])
    ])
val_data = dict(
    type='CocoDataset',
    classes=('spectrum', ),
    ann_file='D:/ZXS/dataset2/annotations_805/instances_val.json',
    img_prefix='D:/ZXS/dataset2/val/images/',
    pipeline=[
        dict(type='LoadImageFromFile'),
        dict(
            type='MultiScaleFlipAug',
...
evaluation = dict(interval=250, metric=['bbox', 'segm'], save_best='bbox_mAP')
...
work_dir = 'D:/ZXS/LineFormer/mmdetection/work_dirs/lineformer_swin_t_805'
auto_resume = False
gpu_ids = [0]
