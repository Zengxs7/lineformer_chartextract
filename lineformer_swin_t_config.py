...
train_data = dict(
    type='CocoDataset',
    classes=('spectrum', ),
    ann_file='D:/ZXS/dataset/annotations_new/instances_train.json',
    img_prefix='D:/ZXS/dataset/train/images/',
    pipeline=[
        dict(type='LoadImageFromFile', to_float32=True),
        dict(
...
val_data = dict(
    type='CocoDataset',
    classes=('spectrum', ),
    ann_file='D:/ZXS/dataset/annotations_new/instances_val.json',
    img_prefix='D:/ZXS/dataset/val/images/',
    pipeline=[
        dict(type='LoadImageFromFile'),
        dict(
            type='MultiScaleFlipAug',
...
work_dir = 'work_dirs/lineformer_swin_t_newest'
auto_resume = False
gpu_ids = [0]
